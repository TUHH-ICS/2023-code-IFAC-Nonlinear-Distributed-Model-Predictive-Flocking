...
% Available Data
simData = [
    "predictive_sqp_flocking_NSQP_1"        % 1
    "predictive_sqp_flocking_NSQP_4"        % 2
    "predictive_sqp_flocking_NSQP_10"       % 3
    "predictive_sqp_flocking_NSQP_100"      % 4
    "predictive_sqp_flocking_comparison"    % 5
    "ndi_flocking_comparison"               % 6
    ];
